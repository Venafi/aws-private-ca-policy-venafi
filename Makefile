...
CERT_REQUEST_LAMBDA_NAME := VenafiCertRequestLambda
...
CERT_POLICY_LAMBDA_NAME := VenafiCertPolicyLambda
...
sam_local_invoke:
	for e in `ls fixtures/events/*-event.json`; do sam local invoke VenafiCertRequestLambda -e $$e; done
